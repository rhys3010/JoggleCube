...
\subsection{Second Year Computer Science Students}
	...
	\subsubsection{Typical Sceond Year Computer Science Student}
		...
		\paragraph{Faith Berry}
			Faith Berry is one of the few girls studying compsci at Aberystwyth University and likes new and interesting challenges, so instead of playing repeatedly against the same board, Faith would like to play against a new grid each time and have an overall high score table,
