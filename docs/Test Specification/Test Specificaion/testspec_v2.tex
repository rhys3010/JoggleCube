...
\usepackage[pdfauthor={Aleksandra Madej, Agata Lefek},pdftitle={Software Engineering Group Project, Test Specification},pdftex]{hyperref}
...
\subsection{FR3  Loading a past grid}
